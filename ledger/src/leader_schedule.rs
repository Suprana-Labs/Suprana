...
mod tests {
    ...
    fn test_leader_schedule_index() {
        let pubkey0 = suprana_sdk::pubkey::new_rand();
        let pubkey1 = suprana_sdk::pubkey::new_rand();
    ...
    fn test_leader_schedule_basic() {
        ...
        let stakes: Vec<_> = (0..num_keys)
            .map(|i| (suprana_sdk::pubkey::new_rand(), i))
            .collect();

        let seed = suprana_sdk::pubkey::new_rand();
    ...
    fn test_repeated_leader_schedule_specific() {
        let alice_pubkey = suprana_sdk::pubkey::new_rand();
