...
mod tests {
    ...
    fn test_next_leader_slot() {
        ...
        assert_eq!(
            cache.next_leader_slot(
                &suprana_sdk::pubkey::new_rand(), // not in leader_schedule
                0,
                &bank,
                None,
                std::u64::MAX
    ...
    fn test_next_leader_slot_next_epoch() {
        ...
        setup_vote_and_stake_accounts(
            ...
            bootstrap_validator_stake_lamports()
                + suprana_stake_program::get_minimum_delegation(&bank.feature_set),
        );
    ...
    fn test_schedule_for_unconfirmed_epoch() {
        ...
        let bank2 = Bank::new_from_parent(bank, &suprana_sdk::pubkey::new_rand(), 95);
