use {
    ...
    inflector::Inflector,
    serde_json::Value,
    suprana_account_decoder::parse_token::spl_token_ids,
    suprana_sdk::{
...
lazy_static! {
    ...
    static ref BPF_LOADER_PROGRAM_ID: Pubkey = suprana_sdk::bpf_loader::id();
    static ref BPF_UPGRADEABLE_LOADER_PROGRAM_ID: Pubkey = suprana_sdk::bpf_loader_upgradeable::id();
