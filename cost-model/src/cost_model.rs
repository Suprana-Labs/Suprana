...
mod tests {
    ...
    fn test_cost_model_transaction_many_transfer_instructions() {
        ...
        let key1 = suprana_sdk::pubkey::new_rand();
        let key2 = suprana_sdk::pubkey::new_rand();
        let instructions =
    ...
    fn test_cost_model_message_many_different_instructions() {
        ...
        let key1 = suprana_sdk::pubkey::new_rand();
        let key2 = suprana_sdk::pubkey::new_rand();
        let prog1 = suprana_sdk::pubkey::new_rand();
        let prog2 = suprana_sdk::pubkey::new_rand();
        let instructions = vec![
    ...
    fn test_cost_model_calculate_cost_all_default() {
        ...
        let expected_loaded_accounts_data_size_cost =
            suprana_program_runtime::compute_budget_processor::MAX_LOADED_ACCOUNTS_DATA_SIZE_BYTES
                as u64
