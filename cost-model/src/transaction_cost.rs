use {crate::block_cost_limits, suprana_sdk::pubkey::Pubkey};
...
impl TransactionCost {
            ...
            Self::SimpleVote { .. } => {
                const _: () = assert!(
                    SIMPLE_VOTE_USAGE_COST
                        == suprana_vote_program::vote_processor::DEFAULT_COMPUTE_UNITS
    ...
    pub fn programs_execution_cost(&self) -> u64 {
        match self {
            Self::SimpleVote { .. } => suprana_vote_program::vote_processor::DEFAULT_COMPUTE_UNITS,
