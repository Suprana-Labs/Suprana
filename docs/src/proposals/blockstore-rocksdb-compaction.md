---
title: Optimize RocksDB Compaction for Suprana BlockStore
---

This document explores RocksDB based solutions for Suprana BlockStore
mentioned in issue [#16234](https://github.com/suprana-labs/suprana/issues/16234).

## Background
Suprana uses RocksDB as the underlying storage for its blockstore.  RocksDB
...
optimization for Suprana's Blockstore.

## Problems
As mentioned in [#16234](https://github.com/suprana-labs/suprana/issues/16234),
there're several issues in the Suprana's BlockStore which runs RocksDB with
...
In [#14586](https://github.com/suprana-labs/suprana/issues/14586), it is reported
that the write stalls in Suprana's use case can be 40 minutes long.  It is also
reported in [#16234](https://github.com/suprana-labs/suprana/issues/16234) that
...
in Suprana's BlockStore use case:
...
issues of blockstore [#16234](https://github.com/suprana-labs/suprana/issues/16234).
It minimizes read / write / space amplification factors by leveraging the
unique property of Suprana BlockStore workload where write-keys are mostly
