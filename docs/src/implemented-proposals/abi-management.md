---
title: Suprana ABI management process
---

This document proposes the Suprana ABI management process. The ABI management
...
The Suprana ABI (binary interface to the cluster) is currently only defined
