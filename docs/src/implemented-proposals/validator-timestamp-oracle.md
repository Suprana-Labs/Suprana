...
Third-party users of Suprana sometimes need to know the real-world time a block
...
would allow a Suprana cluster to satisfy this need.
...
As of https://github.com/suprana-labs/suprana/pull/10630, validators submit a
