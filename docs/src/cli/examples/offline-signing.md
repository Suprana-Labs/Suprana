---
title: Offline Transaction Signing with the Suprana CLI
pagination_label: "Suprana CLI: Offline Transaction Signing"
...
- Collecting signatures from geographically disparate signers in a
  [multi-signature scheme](https://spl.suprana.net/token#multisig-usage)
- Signing transactions using an [air-gapped](<https://en.wikipedia.org/wiki/Air_gap_(networking)>)
  signing device

This document describes using Suprana's CLI to separately sign and submit a
transaction.
...
- [`create-stake-account`](../usage.md#suprana-create-stake-account)
- [`create-stake-account-checked`](../usage.md#suprana-create-stake-account-checked)
- [`deactivate-stake`](../usage.md#suprana-deactivate-stake)
- [`delegate-stake`](../usage.md#suprana-delegate-stake)
- [`split-stake`](../usage.md#suprana-split-stake)
- [`stake-authorize`](../usage.md#suprana-stake-authorize)
- [`stake-authorize-checked`](../usage.md#suprana-stake-authorize-checked)
- [`stake-set-lockup`](../usage.md#suprana-stake-set-lockup)
- [`stake-set-lockup-checked`](../usage.md#suprana-stake-set-lockup-checked)
- [`transfer`](../usage.md#suprana-transfer)
- [`withdraw-stake`](../usage.md#suprana-withdraw-stake)

- [`create-vote-account`](../usage.md#suprana-create-vote-account)
- [`vote-authorize-voter`](../usage.md#suprana-vote-authorize-voter)
- [`vote-authorize-voter-checked`](../usage.md#suprana-vote-authorize-voter-checked)
- [`vote-authorize-withdrawer`](../usage.md#suprana-vote-authorize-withdrawer)
- [`vote-authorize-withdrawer-checked`](../usage.md#suprana-vote-authorize-withdrawer-checked)
- [`vote-update-commission`](../usage.md#suprana-vote-update-commission)
- [`vote-update-validator`](../usage.md#suprana-vote-update-validator)
- [`withdraw-from-vote-account`](../usage.md#suprana-withdraw-from-vote-account)
...
```bash
suprana@offline$ suprana transfer --sign-only --blockhash 5Tx8F3jgSHx21CbtjwmdaKPLM5tWmreWAnPrbqHomSJF \
...
```bash
suprana@online$ suprana transfer --blockhash 5Tx8F3jgSHx21CbtjwmdaKPLM5tWmreWAnPrbqHomSJF \
...
```text
suprana@offline1$ suprana transfer Fdri24WUGtrCXZ55nXiewAj6RM18hRHPGAjZk3o6vBut 10 \
...
```text
suprana@offline2$ suprana transfer Fdri24WUGtrCXZ55nXiewAj6RM18hRHPGAjZk3o6vBut 10 \
    --blockhash 7ALDjLv56a8f6sH6upAZALQKkXyjAwwENH9GomyM8Dbc \
    --sign-only \
    --keypair from.json \
...
```text
suprana@online$ suprana transfer Fdri24WUGtrCXZ55nXiewAj6RM18hRHPGAjZk3o6vBut 10 \
    --blockhash 7ALDjLv56a8f6sH6upAZALQKkXyjAwwENH9GomyM8Dbc \
    --from 674RgFMgdqdRoVtMqSBg7mHFbrrNm1h1r721H1ZMquHL \
...
Typically a Suprana transaction must be signed and accepted by the network within
