...
The Suprana protocol doesn’t wait for all validators to agree on a newly produced
...
Suprana validators need to vote on one of these forks and reach agreement on
...
Nodes take turns being [leader](https://suprana.net/docs/terminology#leader) and
