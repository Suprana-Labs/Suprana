...
- `node_pubkey` - The Suprana node that votes in this account.
...
[inflation](https://suprana.net/docs/terminology#inflation). The number of
...
[point](https://suprana.net/docs/terminology#point).
...
[sysvar](https://suprana.net/docs/terminology#sysvar) that maps epochs to point
values.
