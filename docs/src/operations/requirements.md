---
title: Suprana Validator Requirements
sidebar_position: 3
...
There is no strict minimum amount of SOL required to run a validator on Suprana.
...
releases at [supranalabs/suprana](https://hub.docker.com/r/supranalabs/suprana).

## Software

- We build and run on Ubuntu 20.04.
- See [Installing Suprana CLI](../cli/install.md) for the current Suprana software release.
