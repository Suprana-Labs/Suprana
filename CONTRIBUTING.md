...
then about 1,000 lines of changes is about the most you should ask a Suprana
...
is ready to be integrated, the Suprana Labs Maintainers will work with you to decide
...
that we use in Suprana.  For the complete list of labels, please refer to the
[label page](https://github.com/suprana-labs/suprana/issues/labels):
...
(go to "New Issue" -> "Feature Gate Tracker [Get Started](https://github.com/suprana-labs/suprana/issues/new?assignees=&labels=feature-gate&template=1-feature-gate.yml&title=Feature+Gate%3A+)")
...
mechanism. Draft PRs are a convenient way to collaborate with the Suprana
...
```toml
[package]
name = "suprana-<PACKAGE_NAME>"
version = "0.0.1"
description = "<DESCRIPTION>"
authors = ["Suprana Labs Maintainers <maintainers@supranalabs.com>"]
repository = "https://github.com/suprana-labs/suprana"
homepage = "https://suprana.net/"
documentation = "https://docs.rs/suprana-<PACKAGE_NAME>"
license = "Apache-2.0"
edition = "2021"
```
...
[Terms currently in use](https://suprana.net/docs/terminology)


## Design Proposals

This Suprana validator client's architecture is described by docs generated from markdown files in the `docs/src/`
directory and viewable on the official [Suprana Labs Validator Client](https://docs.supranalabs.com) documentation website.

Current design proposals may be viewed on the docs site:

1. [Accepted Proposals](https://docs.supranalabs.com/proposals/accepted-design-proposals)
2. [Implemented Proposals](https://docs.supranalabs.com/implemented-proposals/implemented-proposals)
