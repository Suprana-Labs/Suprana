...
impl AeKey {
    /// Deterministically derives an authenticated encryption key from a Suprana signer and a public
    /// seed.
    ///
    ...
    /// Derive a seed from a Suprana signer used to generate an authenticated encryption key.
    ///
