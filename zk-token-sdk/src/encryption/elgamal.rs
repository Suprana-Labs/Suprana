...
impl ElGamalKeypair {
    ...
    /// Deterministically derives an ElGamal keypair from a Suprana signer and a public seed.
    ///
    /// This function exists for applications where a user may not wish to maintain a Suprana signer
    ...
    /// a Suprana keypair and a Suprana address as the public seed. However, for general hardware
...
impl ElGamalSecretKey {
    /// Deterministically derives an ElGamal secret key from a Suprana signer and a public seed.
    ///
    ...
    /// Derive a seed from a Suprana signer used to generate an ElGamal secret key.
    ///
...
mod tests {
    use {
        ...
        suprana_sdk::{pubkey::Pubkey, signature::Keypair, signer::null_signer::NullSigner},
        std::fs::{self, File},
    };
